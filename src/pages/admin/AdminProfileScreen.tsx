...
const AdminProfileScreen = () => {
  ...
  return (
    <div className="w-[230px] rounded-[10px] small:w-[80%] mobile:w-[80%] h-[100vh] bg-[white] flex justify-center overflow-hidden ">
      <div className="w-[90%]  ">
        ...
        <div className="w-[100%] mt-[30px] tablet:mt-[50px] ">
          ...
          <div className=" mt-[20px] text-[12px] text-[#c8c7c7] ">
            ...
            maxime praesentium amet officiis incidunt, deleniti esse odit soluta
            quo sunt fuga illum ab aspernatur ea dignissimos laudantium,
            temporibus corrupti excepturi? Nemo perferendis et dolore.
          </div>
        </div>
