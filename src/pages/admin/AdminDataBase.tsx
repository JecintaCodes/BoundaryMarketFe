import { allAdminHooks } from "../../hook/AdminHook";

const AdminDataBase = ()=>{
    const {allAdmin} = allAdminHooks();
        ...
        allAdmin?.map((props:any)=>(
          ...
          <div className="  w-[220px] overflow-hidden mobile:w-[300px] small:w-[300px] ">
            ...
            <div className="mt-[30px] h-[50px] overflow-hidden flex gap-[10px] items-end ">
              <img className="w-[35px] h-[35px] rounded-[50%] object-cover hover:cursor-pointer transition-all hover:scale-[1.05] duration-700 "
              src="https://i.pinimg.com/originals/f7/e9/87/f7e987b4ca06764cc3b834689da56502.jpg" alt="pinimg" />
              <div className="text-[10px] font-bold hover:text-[#18fb18a9] hover:cursor-pointer small:text-[8px] mobile:text-[8px] ">{props?.name}</div>
            </div>
          ...
          <div className="  w-[200px] overflow-hidden mobile:w-[400px] small:w-[400px] ">
            ...
            <div className="mt-[30px] h-[50px] overflow-hidden flex items-end  ">
              <div className="text-[10px] font-bold hover:text-[#18fb18a9] hover:cursor-pointer small:text-[8px] mobile:text-[8px] ">{props?.email}</div>
            </div>
          </div>
          <div className="  w-[100px] overflow-hidden mobile:w-[80px] small:w-[80px] ">
            ...
            <div className="mt-[30px] h-[50px] overflow-hidden  flex items-end   ">
              <div className="text-[10px] font-bold hover:text-[#18fb18a9] hover:cursor-pointer small:text-[8px] mobile:text-[8px]   ">{props?.role}</div>
            </div>
