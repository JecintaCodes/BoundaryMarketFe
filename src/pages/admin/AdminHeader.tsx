  ...
  return (
    <div className="w-[100%] h-[70px] flex justify-center  ">
        <div className="w-[90%] flex justify-between items-center ">
            <div className="text-[25px] font-bold text-[#456104]  small:text-[15px] hover:cursor-pointer mobile:text-[17px] ">BoundaryMarket</div>
            <div className="w-[300px] h-[40px] border-[2px] rounded-[5px] border-[#456104]  ">
              <input
            ...
            <div className="flex justify-center items-center gap-[20px] small:hidden mobile:hidden ">
                ...
                />
                <div className="flex items-center justify-center rounded-full bg-orange-500 text-white text-[10px] w-[15px] h-[15px] absolute top-0 left-2 hover:cursor-pointer animate-bounce "  >0</div>
                </div>
             ...
             <div>
                <AiOutlineArrowDown
                className="hover:cursor-pointer text-[#456104] "
                />
             </div>
            </div>
        </div>
