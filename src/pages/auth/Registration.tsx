  ...
  return (
    ...
    >
        ...
        className="w-[350px] small:w-[80%] mobile:w-[80%] mobile:text-[14px] p-[20px] small:h-[350px] rounded bg-[white] min-h-[400px]  ">
            ...
            <input 
            className="w-[100%] h-[50px] small:h-[35px] mt-[20px] rounded p-[10px] outline-none placeholder:text-[12px] placeholder:text-[#d1cdcd] bg-transparent border-[2px] text-[12px] "  type="password" placeholder="Password " {...register("password")} />
            <input 
            className="w-[100%] h-[50px] small:h-[35px] mt-[20px] rounded p-[10px] outline-none placeholder:text-[12px] placeholder:text-[#d1cdcd] bg-transparent border-[2px] text-[12px] "
            {...register("confirm")}
            type="password" placeholder="confirmPassword   " />
            
            <button className="w-[100%] small:h-[35px] h-[50px] mt-[20px] rounded p-[10px] hover:cursor-pointer hover:scale-[1.05] transition-all duration-500 "
            type="submit"
            style={{
              background:"rgba(179, 184, 231, 0.25)",
              boxShadow:" 0 8px 32px 0 rgba( 31, 38, 135, 0.37  )",
