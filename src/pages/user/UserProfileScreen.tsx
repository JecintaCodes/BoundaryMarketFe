      ...
      <div className="w-[90%]  ">
        <div className="mt-[10px] w-[100%] flex justify-center flex-col items-center ">
         ...
         <img className="w-[130px] h-[150px] rounded-[50%] object-cover small:w-[80px] small:h-[100px] mobile:w-[80px] mobile:h-[100px] hover:cursor-pointer hover:scale-[1.05] transition-all duration-700 " 
          ...
          <div className="font-bold text-[12px] mt-[20px] hover:text-[#18fb18a9] transition-all hover:cursor-pointer ">Onyemaobi Jecinta Ugochi</div>
          <div className="font-bold text-[12px] hover:text-[#18fb18a9] transition-all hover:cursor-pointer  ">onyemaobijecintaugochi@gmail.com</div>
          <div className="font-bold text-[12px] hover:text-[#18fb18a9] transition-all hover:cursor-pointer  ">https://onyemaobijecinta</div>
          <div className="font-bold text-[12px] hover:text-[#18fb18a9] transition-all hover:cursor-pointer  ">instagram.com</div>
        </div>
