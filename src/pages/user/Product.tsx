...
const Product = () => {
 ...
 <div className="w-[100%] h-[100%] flex justify-center ">
  ...
  <div className="w-[90%] small:w-[90%] mobile:w-[90%]   ">
    <div className="mt-[20px]">Hello {data?.name}</div>
  ...
  {/* card */}
  {
   ...
   allProduct?.map((props:any)=>(
    <div className="w-[200px] h-[230px] border mt-[30px] rounded-[10px] overflow-hidden small:w-[150px] mobile:w-[150px] " key={props?._id} >
    {/* image */}
    <img 
