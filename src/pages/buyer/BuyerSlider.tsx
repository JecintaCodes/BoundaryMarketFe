  ...
  return (
    ...
    <div className="w-[200px] mobile:hidden small:hidden small:w-[50%] h-[100vh] bg-orange-500 rounded-[10px] overflow-hidden flex justify-center mobile:w-[50%]  ">
        <div className="w-[90%]  ">
            ...
            <AiOutlineMessage/>
            <div>Messenger</div>
                <div className="flex items-center justify-center rounded-full  text-white text-[11px] w-[25px] h-[25px] absolute top-1 right-2 animate-ping bg-red-500 " >0</div>
                </div>
                </Link>
