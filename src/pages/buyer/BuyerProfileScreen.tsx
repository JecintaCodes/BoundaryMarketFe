      ...
      <div className="w-[90%]  ">
        <div className="mt-[10px] w-[100%] flex justify-center flex-col items-center ">
         ...
         <img className="w-[130px] h-[150px] rounded-[50%] object-cover small:w-[80px] small:h-[100px] mobile:w-[80px] mobile:h-[100px] hover:cursor-pointer hover:scale-[1.05] transition-all duration-700 " 
          ...
          <div className="font-bold text-[12px] mt-[20px] hover:text-[#456104] transition-all hover:cursor-pointer ">{data?.name}</div>
          <div className="font-bold text-[12px] hover:text-[#456104] transition-all hover:cursor-pointer  ">{data?.email}</div>
        </div>
        <div className="w-[100%] flex justify-center gap-[20px] items-center mt-[20px] font-bold text-[20px] ">
         ...
         <AiOutlineMessage/>
          ...
          <AiOutlineMail/>
                    ...
                    <div className=" mt-[20px] text-[12px] text-[#838181] ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta iure maxime praesentium amet officiis incidunt, deleniti esse odit soluta quo sunt fuga illum ab aspernatur ea dignissimos laudantium, temporibus corrupti excepturi? Nemo perferendis et dolore.</div>
                    </div>
